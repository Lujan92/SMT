...
$(".mes1").click(function () {
    $("#cantidad").html((formatMoney(80 * qty_licencias.val())));
    $('#periodo').prop('checked', false);
    $('.mes1').prop('checked', true);
});
$(".mes3").click(function () {
    $("#cantidad").html((formatMoney(615 * qty_licencias.val())));

    $('#periodo').prop('checked', false);
    $('.mes3').prop('checked', true);
});
$(".mes4").click(function () {
    $("#cantidad").html((formatMoney(700 * qty_licencias.val())));
    $('#periodo').prop('checked', false);
    $('.mes4').prop('checked', true);
});
$(".mes6").click(function () {
    $("#cantidad").html((formatMoney(900 * qty_licencias.val())));
    $('#periodo').prop('checked', false);
    $('.mes6').prop('checked', true);
});
$(".mes10").click(function () {
    $("#cantidad").html((formatMoney(1490 * qty_licencias.val())));
    $('#periodo').prop('checked', false);
