var Examen = new function () {
    ...
    this.nuevoRR = function (selector, estado) {
    ...
    $('body:not(.visualizando)').delegate('[data-option="pregunta"]', 'click', function () {
        ...
        $.validator.unobtrusive.parse($('#frmExamenRR'));
    });
    ...
    $('body:not(.visualizando)').delegate('#frmExamenRR [data-option="eliminar-pregunta"]', 'click', function () {
...
$('body:not(.visualizando)').delegate('[data-examen="nuevoRR"]', 'click', function () {
    Examen.nuevoRR('#tabla-examen', 1);
});

$('body:not(.visualizando)').delegate('#frmExamenRR textarea', 'keypress', function (e) {
    if (e.keyCode == 13) {
